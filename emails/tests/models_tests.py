...
class RelayAddressTest(TestCase):
    ...
    @patch("emails.models.has_bad_words", return_value=False)
    @patch("emails.models.is_blocklisted", side_effect=[True, False])
    def test_address_contains_blocklist_invalid(
        self, mock_blocklist: Mock, mock_has_bad_words: Mock
    ) -> None:
